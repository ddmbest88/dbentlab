...
if (isset($_POST['cerca'])){
	...
	//else{
		...
		echo $tableheader;
			...
			if($ruolo=!""&&$ruolo=="administrator"||$ruolo=="generalmanager"||$ruolo=="amministratoreunico"||$ruolo=="supervisore"){echo"<td ><a href=./finaldestination.php?ID=".$userRow['ID']."&ruolo=".$_GET['ruolo']."&username=".$_GET['username']."&azione=sposta ><button type=”submit”>Sposta in magazzino</button></form></td>";}
			echo"</tr>"; 
			}
